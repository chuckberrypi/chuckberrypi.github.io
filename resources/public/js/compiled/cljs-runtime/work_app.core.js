...
datascript.core.listen_BANG_.cljs$core$IFn$_invoke$arity$2(work_app.core.conn,(function (p1__53647_SHARP_){
return console.log(cljs.core.clj__GT_js(new cljs.core.Keyword(null,"tx-data","tx-data",934159761).cljs$core$IFn$_invoke$arity$1(p1__53647_SHARP_)));
}));
...
var G__53648 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.events","dialog-toggle","work-app.events/dialog-toggle",788448125)], null);
return (work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__53648) : work_app.events._GT_evt.call(null,G__53648));
...
var G__53649_53656 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.events","dialog-confirmed","work-app.events/dialog-confirmed",-1275411289)], null);
(work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__53649_53656) : work_app.events._GT_evt.call(null,G__53649_53656));

var G__53650 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.events","dialog-toggle","work-app.events/dialog-toggle",788448125)], null);
return (work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__53650) : work_app.events._GT_evt.call(null,G__53650));
...
var G__53651 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.events","dialog-toggle","work-app.events/dialog-toggle",788448125)], null);
return (work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__53651) : work_app.events._GT_evt.call(null,G__53651));
})], null)], null)], null);
});
...
var G__53652 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.events","set-toast","work-app.events/set-toast",1818151911),el], null);
return (work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__53652) : work_app.events._GT_evt.call(null,G__53652));
...
var G__53653 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.events","tick","work-app.events/tick",1737052786)], null);
return (work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__53653) : work_app.events._GT_evt.call(null,G__53653));
}),(1000));
...
var G__53654 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.events","key-press","work-app.events/key-press",-1858630462),e], null);
return (work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__53654) : work_app.events._GT_evt.call(null,G__53654));
}),(function (){var G__53655 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.events","initialize-db","work-app.events/initialize-db",1599662938)], null);
return (work_app.events._GT_evt_sync.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt_sync.cljs$core$IFn$_invoke$arity$1(G__53655) : work_app.events._GT_evt_sync.call(null,G__53655));
