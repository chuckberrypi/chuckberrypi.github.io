...
var formik = module$node_modules$formik$dist$index.useFormik(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"initialValues","initialValues",-2055525019),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"c-num","c-num",1611632000),"",new cljs.core.Keyword(null,"m-num","m-num",81000627),"",new cljs.core.Keyword(null,"c-name","c-name",-1471300880),"",new cljs.core.Keyword(null,"m-name","m-name",-1838368401),""], null),new cljs.core.Keyword(null,"onSubmit","onSubmit",761425194),(function (p1__52850_SHARP_){
var G__52854_52955 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.matter-events","toggle-new-cm-dialog-showing","work-app.matter-events/toggle-new-cm-dialog-showing",548953577)], null);
(work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__52854_52955) : work_app.events._GT_evt.call(null,G__52854_52955));

var G__52855 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.matter-events","add-new-client-matter","work-app.matter-events/add-new-client-matter",204426496),cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(p1__52850_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0))], null);
return (work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__52855) : work_app.events._GT_evt.call(null,G__52855));
})], null)));
...
var formik = module$node_modules$formik$dist$index.useFormik(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"initialValues","initialValues",-2055525019),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"client-id","client-id",-464622140),initial_val,new cljs.core.Keyword(null,"m-num","m-num",81000627),cljs.core.str.cljs$core$IFn$_invoke$arity$1(initial_val),new cljs.core.Keyword(null,"m-name","m-name",-1838368401),""], null),new cljs.core.Keyword(null,"onSubmit","onSubmit",761425194),(function (p1__52868_SHARP_){
var vls = cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(p1__52868_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
var G__52877_52960 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.matter-events","toggle-new-cm-dialog-showing","work-app.matter-events/toggle-new-cm-dialog-showing",548953577)], null);
(work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__52877_52960) : work_app.events._GT_evt.call(null,G__52877_52960));

var G__52878_52961 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.events","log","work-app.events/log",2121905114),cljs.core.str.cljs$core$IFn$_invoke$arity$1(vls)], null);
(work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__52878_52961) : work_app.events._GT_evt.call(null,G__52878_52961));

var G__52879 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.matter-events","add-new-matter","work-app.matter-events/add-new-matter",2101231876),vls], null);
return (work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__52879) : work_app.events._GT_evt.call(null,G__52879));
})], null)));
...
(work_app.matters.Row_opts.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k52893,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k52893,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__52909){
var vec__52910 = p__52909;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52910,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52910,(1),null);
...
(work_app.matters.Row_opts.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__52892){
var self__ = this;
var G__52892__$1 = this;
return (new cljs.core.RecordIter((0),G__52892__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"cm","cm",540591536)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(work_app.matters.Row_opts.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this52894,other52895){
var self__ = this;
var this52894__$1 = this;
return (((!((other52895 == null)))) && ((((this52894__$1.constructor === other52895.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52894__$1.cm,other52895.cm)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52894__$1.__extmap,other52895.__extmap)))))));
}));
...
(work_app.matters.Row_opts.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k52893){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k52893);

}
}));

(work_app.matters.Row_opts.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__52892){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__52919 = cljs.core.keyword_identical_QMARK_;
var expr__52920 = k__5352__auto__;
if(cljs.core.truth_((pred__52919.cljs$core$IFn$_invoke$arity$2 ? pred__52919.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"cm","cm",540591536),expr__52920) : pred__52919.call(null,new cljs.core.Keyword(null,"cm","cm",540591536),expr__52920)))){
return (new work_app.matters.Row_opts(G__52892,self__.__meta,self__.__extmap,null));
} else {
return (new work_app.matters.Row_opts(self__.cm,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__52892),null));
}
}));
...
(work_app.matters.Row_opts.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__52892){
var self__ = this;
var this__5342__auto____$1 = this;
return (new work_app.matters.Row_opts(self__.cm,G__52892,self__.__extmap,self__.__hash));
}));
 ...
 */
work_app.matters.map__GT_Row_opts = (function work_app$matters$map__GT_Row_opts(G__52903){
var extmap__5385__auto__ = (function (){var G__52922 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__52903,new cljs.core.Keyword(null,"cm","cm",540591536));
if(cljs.core.record_QMARK_(G__52903)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__52922);
} else {
return G__52922;
}
})();
return (new work_app.matters.Row_opts(new cljs.core.Keyword(null,"cm","cm",540591536).cljs$core$IFn$_invoke$arity$1(G__52903),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var G__52923 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.events","copy-text","work-app.events/copy-text",-162880538),cm], null);
return (work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__52923) : work_app.events._GT_evt.call(null,G__52923));
})], null)], null)], null)], null));
});
work_app.matters.edit_dialog = (function work_app$matters$edit_dialog(client_num,matter_num){
var map__52925 = work_app.subs._LT_sub(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.subs","matters-matter","work-app.subs/matters-matter",899046157),client_num,matter_num], null));
var map__52925__$1 = cljs.core.__destructure_map(map__52925);
var data = map__52925__$1;
var client_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52925__$1,new cljs.core.Keyword(null,"client-name","client-name",1843891115));
var client_num__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52925__$1,new cljs.core.Keyword(null,"client-num","client-num",-1900559089));
var matter_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52925__$1,new cljs.core.Keyword(null,"matter-name","matter-name",-359115844));
var matter_num__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52925__$1,new cljs.core.Keyword(null,"matter-num","matter-num",-1351918268));
var formik = module$node_modules$formik$dist$index.useFormik(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"initialValues","initialValues",-2055525019),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"matter-num","matter-num",-1351918268),matter_num__$1,new cljs.core.Keyword(null,"matter-name","matter-name",-359115844),matter_name,new cljs.core.Keyword(null,"client-num","client-num",-1900559089),client_num__$1,new cljs.core.Keyword(null,"client-name","client-name",1843891115),client_name], null),new cljs.core.Keyword(null,"onSubmit","onSubmit",761425194),(function (p1__52924_SHARP_){
var packet = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"old","old",-1825222690),data], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"new","new",-2085437848),cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(p1__52924_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0))], null)], 0));
console.log(["New Vals: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(packet)].join(''));

var G__52926_52973 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.events","matters-toggle-edit-dialog-showing","work-app.events/matters-toggle-edit-dialog-showing",1661565174),data], null);
(work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__52926_52973) : work_app.events._GT_evt.call(null,G__52926_52973));

var G__52927 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.events","matters-edit-matter","work-app.events/matters-edit-matter",53605894),packet], null);
return (work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__52927) : work_app.events._GT_evt.call(null,G__52927));
})], null)));
...
var G__52928 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.events","matters-toggle-edit-dialog-showing","work-app.events/matters-toggle-edit-dialog-showing",1661565174),data], null);
return (work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__52928) : work_app.events._GT_evt.call(null,G__52928));
...
var map__52934 = cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(data,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
var map__52934__$1 = cljs.core.__destructure_map(map__52934);
var d = map__52934__$1;
var client_num = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52934__$1,new cljs.core.Keyword(null,"client-num","client-num",-1900559089));
var matter_num = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52934__$1,new cljs.core.Keyword(null,"matter-num","matter-num",-1351918268));
...
var G__52935 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.events","matters-toggle-edit-dialog-showing","work-app.events/matters-toggle-edit-dialog-showing",1661565174),d], null);
return (work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__52935) : work_app.events._GT_evt.call(null,G__52935));
...
var G__52936 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.events","matters-delete-matter","work-app.events/matters-delete-matter",1722746536),d], null);
return (work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__52936) : work_app.events._GT_evt.call(null,G__52936));
})], null)], null)], null));
});
...
var G__52937 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.matter-events","toggle-new-cm-dialog-showing","work-app.matter-events/toggle-new-cm-dialog-showing",548953577)], null);
return (work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__52937) : work_app.events._GT_evt.call(null,G__52937));
...
var G__52938 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.events","matters-toggle-new-or-existing-cm","work-app.events/matters-toggle-new-or-existing-cm",-1782470261)], null);
return (work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__52938) : work_app.events._GT_evt.call(null,G__52938));
...
var G__52939 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.matter-events","toggle-new-cm-dialog-showing","work-app.matter-events/toggle-new-cm-dialog-showing",548953577)], null);
return (work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1 ? work_app.events._GT_evt.cljs$core$IFn$_invoke$arity$1(G__52939) : work_app.events._GT_evt.call(null,G__52939));
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),["cms: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cms)].join('')], null),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function work_app$matters$matters_$_iter__52940(s__52941){
return (new cljs.core.LazySeq(null,(function (){
var s__52941__$1 = s__52941;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__52941__$1);
if(temp__5804__auto__){
var s__52941__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__52941__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__52941__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__52943 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__52942 = (0);
while(true){
if((i__52942 < size__5522__auto__)){
var map__52944 = cljs.core._nth(c__5521__auto__,i__52942);
var map__52944__$1 = cljs.core.__destructure_map(map__52944);
var m_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52944__$1,new cljs.core.Keyword(null,"m-id","m-id",1795173264));
cljs.core.chunk_append(b__52943,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),cljs.core.str.cljs$core$IFn$_invoke$arity$1(work_app.subs._LT_sub(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.matter-subs","matter-code-menu-opts","work-app.matter-subs/matter-code-menu-opts",1660266215)], null)))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),m_id], null)));

var G__52976 = (i__52942 + (1));
i__52942 = G__52976;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__52943),work_app$matters$matters_$_iter__52940(cljs.core.chunk_rest(s__52941__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__52943),null);
}
} else {
var map__52954 = cljs.core.first(s__52941__$2);
var map__52954__$1 = cljs.core.__destructure_map(map__52954);
var m_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52954__$1,new cljs.core.Keyword(null,"m-id","m-id",1795173264));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),cljs.core.str.cljs$core$IFn$_invoke$arity$1(work_app.subs._LT_sub(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("work-app.matter-subs","matter-code-menu-opts","work-app.matter-subs/matter-code-menu-opts",1660266215)], null)))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),m_id], null)),work_app$matters$matters_$_iter__52940(cljs.core.rest(s__52941__$2)));
}
} else {
return null;
}
